        ...
        <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
            <div class="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
                <router-link :to="{ name: 'mahasiswa.dashboard' }">
                    <a class="text-slate-700 text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase"
                        href="#">
                        <ComputerDesktopIcon class="h-5 -mt-1 w-5 inline-block" />
                        DIL ML
                    </a>
                </router-link>
                <button
            ...
            <div class="lg:flex flex-grow items-center" :class="[navbarOpen ? 'block' : 'hidden']"
                ...
                <ul class="flex flex-col lg:flex-row list-none lg:ml-auto gap-4">
                    ...
                    <li class="flex items-center">
                        <a :href="getPedoman()" target="_blank" download=""
                            class="hover:text-blueGray-500 text-blueGray-700 px-3 py-2 flex items-center text-xs uppercase font-bold">
                            Pedoman Sistem </a>
                    </li>
                    <li class="flex items-center">
                        <button @click="logout"
                            ...
                            type="button">
                            Keluar
                            <ArrowLeftOnRectangleIcon class="h-5 w-5 -mt-1 inline-block" />
                        </button>
                    </li>
                </ul>
            </div>
...
<script setup>
import { ComputerDesktopIcon, Bars3BottomRightIcon, ArrowLeftOnRectangleIcon } from '@heroicons/vue/20/solid'
